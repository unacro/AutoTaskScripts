...
但这样就有一个问题，长期在后台挂着直播，对我手上这台 5年高龄的渣本 来说不能算毫无压力，而是20%左右的CPU占用和1/8的内存占用。并不算多，但如果我后台还挂着别的东西，多开几个狂吃内存的IDE（比如PhpStorm啦、PyCharm啦、GoLand啦），再开几个游戏……
...
> 至于广为流传的人设和本人人格是否一致，有多少一致，是另外一说。
