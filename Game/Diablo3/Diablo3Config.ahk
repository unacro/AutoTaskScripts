...
class Diablo3Config {
    ...
    static FIRE_MODE_DELAY := Array([0, 600, 2400, 600, 150, 600], [-1, -1, 600, 600, 150, -1], [-1, -1, -1, -1, -1, -1])
    static FIRE_SP_MODE_DELAY := Array([0, 600, 120, 600, 150, 600], [600, -1, 600, 600, 150, -1], [-1, -1, -1, -1, -1, -1])
    ...
    ; [切换巅峰等级到主属性] 键位
    static KEY_SWITCH_PARAGON_MAIN := "Home"

    ; [切换巅峰等级到体能] 键位
    static KEY_SWITCH_PARAGON_HP := "PgUp"

    ; [快速确认] 键位 sc02b即反斜杠/回车上面那个键
    static KEY_QUICK_CONFIM := "\|Insert"

    ; [快速附魔] 键位
    static KEY_QUICK_ENCHANT := "PgDn"

    ; [自动修理并分解蓝白黄] 键位
    static KEY_AUTO_FIX_AND_BREAK := "MButton|End"

    ; [自动赌血岩] 键位
    static KEY_AUTO_CAST_BLOODSHARD := "Delete"
