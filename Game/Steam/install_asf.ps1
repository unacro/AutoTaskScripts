<##
 ...
 # Description: ArchiSteamFarm ASF自动部署脚本 Windows Ver (Powered By PowerShell)
 #>
...
function Get-ZipFile {
    ...
    Write-Host "[Info] 如果由于网络问题，下载失败或用时过长，请自行前往 https://github.com/JustArchiNET/ArchiSteamFarm/releases 手动下载正确版本（ASF-win-x64.zip）。"
